...
public class ForEachTagTest extends TestCase {
	...
	protected void check(Workbook workbook) {
		...
		// assertEquals(IndexedColors.PALE_BLUE.getIndex(), getCell(vertVert,
		// 29, 4).getCellStyle().getFillForegroundColor());
		...
		// getCell(vertVert, 46, 1).getCellStyle().getFillForegroundColor());
		...
		// getFillForegroundColor returns zero for XSSFCellStyles!!!
		// assertEquals(IndexedColors.PALE_BLUE.getIndex(), getCell(vertVert,
		// 77, 4).getCellStyle().getFillForegroundColor());
		...
		// assertEquals(IndexedColors.GREY_25_PERCENT.getIndex(),
		// getCell(vertVert, 94, 1).getCellStyle().getFillForegroundColor());
		...
		// getFillForegroundColor returns zero for XSSFCellStyles!!!
		// assertEquals(IndexedColors.PALE_BLUE.getIndex(), getCell(horizVert,
		// 1, 24).getCellStyle().getFillForegroundColor());
		...
		// assertEquals(IndexedColors.GREY_25_PERCENT.getIndex(),
		// getCell(horizVert, 2, 35).getCellStyle().getFillForegroundColor());
		...
		// getFillForegroundColor returns zero for XSSFCellStyles!!!
		// assertEquals(IndexedColors.PALE_BLUE.getIndex(), getCell(horizVert,
		// 10, 24).getCellStyle().getFillForegroundColor());
		...
		// assertEquals(IndexedColors.GREY_25_PERCENT.getIndex(),
		// getCell(horizVert, 11, 35).getCellStyle().getFillForegroundColor());
		...
		// getFillForegroundColor returns zero for XSSFCellStyles!!!
		// assertEquals(IndexedColors.PALE_BLUE.getIndex(), getCell(vertHoriz,
		// 24, 1).getCellStyle().getFillForegroundColor());
		...
		// assertEquals(IndexedColors.GREY_25_PERCENT.getIndex(),
		// getCell(vertHoriz, 35, 2).getCellStyle().getFillForegroundColor());
		...
		// getFillForegroundColor returns zero for XSSFCellStyles!!!
		// assertEquals(IndexedColors.PALE_BLUE.getIndex(), getCell(vertHoriz,
		// 24, 10).getCellStyle().getFillForegroundColor());
		...
		// assertEquals(IndexedColors.GREY_25_PERCENT.getIndex(),
		// getCell(vertHoriz, 35, 11).getCellStyle().getFillForegroundColor());
		...
		// getFillForegroundColor returns zero for XSSFCellStyles!!!
		// assertEquals(IndexedColors.PALE_BLUE.getIndex(), getCell(horizHoriz,
		// 4, 29).getCellStyle().getFillForegroundColor());
		...
		// assertEquals(IndexedColors.GREY_25_PERCENT.getIndex(),
		// getCell(horizHoriz, 1, 46).getCellStyle().getFillForegroundColor());
		...
		// getFillForegroundColor returns zero for XSSFCellStyles!!!
		// assertEquals(IndexedColors.PALE_BLUE.getIndex(), getCell(horizHoriz,
		// 4, 77).getCellStyle().getFillForegroundColor());
		...
		// assertEquals(IndexedColors.GREY_25_PERCENT.getIndex(),
		// getCell(horizHoriz, 1, 94).getCellStyle().getFillForegroundColor());
		...
		expInds.put(1, "0 of 8");
		expInds.put(2, "0 of 5");
		expInds.put(3, "1 of 5");
		expInds.put(4, "2 of 5");
		expInds.put(5, "3 of 5");
		expInds.put(6, "4 of 5");
		expInds.put(8, "1 of 8");
		expInds.put(9, "0 of 5");
		expInds.put(10, "1 of 5");
		expInds.put(11, "2 of 5");
		expInds.put(12, "3 of 5");
		expInds.put(13, "4 of 5");
		expInds.put(15, "2 of 8");
		expInds.put(16, "0 of 5");
		expInds.put(17, "1 of 5");
		expInds.put(18, "2 of 5");
		expInds.put(19, "3 of 5");
		expInds.put(20, "4 of 5");
		expInds.put(22, "3 of 8");
		expInds.put(23, "0 of 5");
		expInds.put(24, "1 of 5");
		expInds.put(25, "2 of 5");
		expInds.put(26, "3 of 5");
		expInds.put(27, "4 of 5");
		expInds.put(29, "4 of 8");
		expInds.put(30, "0 of 5");
		expInds.put(31, "1 of 5");
		expInds.put(32, "2 of 5");
		expInds.put(33, "3 of 5");
		expInds.put(34, "4 of 5");
		expInds.put(36, "5 of 8");
		expInds.put(37, "0 of 5");
		expInds.put(38, "1 of 5");
		expInds.put(39, "2 of 5");
		expInds.put(40, "3 of 5");
		expInds.put(41, "4 of 5");
		expInds.put(43, "6 of 8");
		expInds.put(45, "7 of 8");
		expInds.put(46, "0 of 1");
