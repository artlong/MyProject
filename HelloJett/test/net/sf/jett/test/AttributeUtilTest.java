...
public class AttributeUtilTest {
	...
	public void setup() {
		...
		myBeans.put("acronym",
				Arrays.asList("Java", "Excel", "Template", "Translator"));
		myBeans.put("integerArray", new Integer[] { 4, 8, 15, 16, 23, 42 });
		myBeans.put("integerArrayArray", new Integer[][] {
				new Integer[] { 4, 8 }, new Integer[] { 15, 16, 23 },
				new Integer[] { 42 } });
		...
		myTag = new BaseTag() {
			...
			/**
			 * Returns a dummy <code>TagContext</code> with a dummy
			 * <code>Block</code>.
			 * 
			 ...
			 * dummy <code>ExpressionFactory</code> and a dummy tag locations
			 * map.
			 * 
	...
	public void testBooleanTrue() {
		assertTrue(AttributeUtil.evaluateBoolean(myTag, new XSSFRichTextString(
				"${t}"), myBeans, false));
	}
	...
	public void testBooleanFalse() {
		assertFalse(AttributeUtil.evaluateBoolean(myTag,
				new XSSFRichTextString("${f}"), myBeans, true));
	}
	...
	public void testBooleanDNE() {
		AttributeUtil.evaluateBoolean(myTag, new XSSFRichTextString("${dne}"),
				myBeans, true);
	}
	...
	public void testEvaluateInt() {
		assertEquals(42, AttributeUtil.evaluateInt(myTag,
				new XSSFRichTextString("${answer}"), myBeans, "attr_name", 0));
	}
	...
	public void testEvaluateIntBad() {
		AttributeUtil.evaluateInt(myTag, new XSSFRichTextString("${t}"),
				myBeans, "attr_name", 0);
	}
	...
	public void testEvaluateIntDNE() {
		AttributeUtil.evaluateInt(myTag, new XSSFRichTextString("${dne}"),
				myBeans, "attr_name", 0);
	}
	...
	public void testEvaluateNonNegativeIntPositive() {
		assertEquals(42, AttributeUtil.evaluateNonNegativeInt(myTag,
				new XSSFRichTextString("${answer}"), myBeans, "attr_name", -1));
	}
	...
	public void testEvaluateNonNegativeIntZero() {
		assertEquals(0, AttributeUtil.evaluateNonNegativeInt(myTag,
				new XSSFRichTextString("${zero}"), myBeans, "attr_name", -1));
	}
	...
	public void testEvaluateNonNegativeNegative() {
		AttributeUtil.evaluateNonNegativeInt(myTag, new XSSFRichTextString(
				"${isquared}"), myBeans, "attr_name", 0);
	}
	...
	public void testEvaluatePositiveIntPositive() {
		assertEquals(42, AttributeUtil.evaluatePositiveInt(myTag,
				new XSSFRichTextString("${answer}"), myBeans, "attr_name", -1));
	}
	...
	public void testEvaluatePositiveIntZero() {
		AttributeUtil.evaluatePositiveInt(myTag, new XSSFRichTextString(
				"${zero}"), myBeans, "attr_name", -1);
	}
	...
	public void testEvaluateNonZeroIntPositive() {
		assertEquals(42, AttributeUtil.evaluateNonZeroInt(myTag,
				new XSSFRichTextString("${answer}"), myBeans, "attr_name", -1));
	}
	...
	public void testEvaluateNonZeroIntZero() {
		AttributeUtil.evaluateNonZeroInt(myTag, new XSSFRichTextString(
				"${zero}"), myBeans, "attr_name", -1);
	}
	...
	public void testEvaluateNonZeroIntNegative() {
		assertEquals(-1, AttributeUtil.evaluateNonZeroInt(myTag,
				new XSSFRichTextString("${isquared}"), myBeans, "attr_name", 0));
	}
	...
	public void testEvaluateDouble() {
		assertEquals(8.6,
				AttributeUtil.evaluateDouble(myTag, new XSSFRichTextString(
						"${question}"), myBeans, "attr_name", 0), 0.0000001);
	}
	...
	public void testEvaluateDoubleBad() {
		AttributeUtil.evaluateDouble(myTag, new XSSFRichTextString("${t}"),
				myBeans, "attr_name", 0);
	}
	...
	public void testEvaluateDoubleDNE() {
		AttributeUtil.evaluateDouble(myTag, new XSSFRichTextString("${dne}"),
				myBeans, "attr_name", 0);
	}
	...
	public void testEvaluateRichTextStringNotNull() {
		RichTextString result = (RichTextString) AttributeUtil
				.evaluateRichTextStringNotNull(myTag, new XSSFRichTextString(
						"Name: ${bugs.lastName}, ${bugs.firstName}"),
	...
	public void testEvaluateRichTextStringNull() {
		AttributeUtil.evaluateRichTextStringNotNull(myTag,
				new XSSFRichTextString("${null}"), new TestCreationHelper(),
				myBeans, "attr_name", "");
	}
	...
	public void testEvaluateString() {
		assertEquals("JETT", AttributeUtil.evaluateString(myTag,
				new XSSFRichTextString("${project}"), myBeans, null));
	}
	...
	public void testEvaluateStringNull() {
		assertNull(AttributeUtil.evaluateString(myTag, new XSSFRichTextString(
				"${null}"), myBeans, "notNullDefault"));
	}

	// Can't have this test, because we have to have null be a valid possible
	// result.
	// @Test(expected = AttributeExpressionException.class)
	// public void testEvaluateStringDNE()
	// {
	// AttributeUtil.evaluateString(new XSSFRichTextString("${dne}"), myBeans,
	// null);
	// }
	...
	public void testEvaluateStringNotNull() {
		AttributeUtil.evaluateStringNotNull(myTag, new XSSFRichTextString(
				"${null}"), myBeans, "attr_name", "notNullDefault");
	}
	...
	public void testEvaluateStringSpecificValues() {
		assertEquals("JETT", AttributeUtil.evaluateStringSpecificValues(myTag,
				new XSSFRichTextString("${project}"), myBeans, "attr_name",
	...
	public void testEvaluateStringSpecificValuesNotFound() {
		AttributeUtil.evaluateStringSpecificValues(myTag,
				new XSSFRichTextString("${project}"), myBeans, "attr_name",
	...
	public void testEvaluateObjectDNE() {
		AttributeUtil.evaluateObject(myTag, "${dne}", myBeans, "attr_name",
				String.class, "notNullDefault");
	}
	...
	public void testEvaluateObject() {
		Object obj = AttributeUtil.evaluateObject(myTag, "${bugs}", myBeans,
				"attr_name", Employee.class, null);
		assertNotNull(obj);
	...
	public void testEvaluateObjectWrongClass() {
		AttributeUtil.evaluateObject(myTag, "${bugs}", myBeans, "attr_name",
				Division.class, null);
	}
	...
	public void testEvaluateObjectInstantiate() {
		Object obj = AttributeUtil.evaluateObject(myTag,
				"net.sf.jett.test.model.Employee", myBeans, "attr_name",
				Employee.class, null);
		assertNotNull(obj);
		assertTrue(obj instanceof Employee);
	}
	...
	public void testEvaluateObjectInstantiateWrongClass() {
		AttributeUtil.evaluateObject(myTag, "net.sf.jett.test.model.Employee",
				myBeans, "attr_name", Division.class, null);
	}
	...
	public void testEvaluateListDNE() {
		AttributeUtil.evaluateList(myTag, new XSSFRichTextString("${dne}"),
				myBeans, null);
	}
	...
	public void testEvaluateList() {
		Object obj = AttributeUtil.evaluateList(myTag, new XSSFRichTextString(
				"${acronym}"), myBeans, null);
		assertNotNull(obj);
	...
	public void testEvaluateListSemicolonSeparated() {
		Object obj = AttributeUtil.evaluateList(myTag, new XSSFRichTextString(
				"four;eight;fifteen;sixteen;twenty-three;forty-two"), myBeans,
				null);
		assertNotNull(obj);
		assertTrue(obj instanceof List);
		List list = (List) obj;
		assertEquals(6, list.size());
		List<String> expected = Arrays.asList("four", "eight", "fifteen",
	...
	public void testEvaluateIntegerArrayDNE() {
		AttributeUtil.evaluateIntegerArray(myTag, new XSSFRichTextString(
				"${dne}"), myBeans, Arrays.asList(1));
	}
	...
	public void testEvaluateIntegerArray() {
		List<Integer> intList = AttributeUtil.evaluateIntegerArray(myTag,
				new XSSFRichTextString("${[4, 8, 15, 16, 23, 42]}"), myBeans,
				null);
	...
	public void testEvaluateIntegerArrayIntegerArray() {
		List<Integer> intList = AttributeUtil.evaluateIntegerArray(myTag,
				new XSSFRichTextString("${integerArray}"), myBeans, null);
		assertNotNull(intList);
		assertEquals(6, intList.size());
		List<Integer> expected = Arrays.asList(4, 8, 15, 16, 23, 42);
		for (int i = 0; i < expected.size(); i++) {
	...
	public void testEvaluateIntegerArrayParse() {
		List<Integer> intList = AttributeUtil.evaluateIntegerArray(myTag,
				new XSSFRichTextString("4;8;15;16;23;42"), myBeans, null);
		assertNotNull(intList);
		assertEquals(6, intList.size());
		List<Integer> expected = Arrays.asList(4, 8, 15, 16, 23, 42);
		for (int i = 0; i < expected.size(); i++) {
	...
	public void testEvaluateIntegerArrayArrayDNE() {
		...
		AttributeUtil.evaluateIntegerArrayArray(myTag, new XSSFRichTextString(
				"${dne}"), myBeans, def);
	}
	...
	public void testEvaluateIntegerArrayArray() {
		List<List<Integer>> intList = AttributeUtil.evaluateIntegerArrayArray(
				myTag,
				new XSSFRichTextString("${[[4, 8], [15, 16, 23], [42]]}"),
				myBeans, null);
		assertNotNull(intList);
	...
	public void testEvaluateIntegerArrayArrayIntegerArrayArray() {
		List<List<Integer>> intList = AttributeUtil.evaluateIntegerArrayArray(
				myTag, new XSSFRichTextString("${integerArrayArray}"), myBeans,
				null);
		assertNotNull(intList);
		assertEquals(3, intList.size());
	...
	public void testEvaluateIntegerArrayArrayParse() {
		List<List<Integer>> intList = AttributeUtil
				.evaluateIntegerArrayArray(myTag, new XSSFRichTextString(
						"4,8;15,16,23;42"), myBeans, null);
		assertNotNull(intList);
		assertEquals(3, intList.size());
